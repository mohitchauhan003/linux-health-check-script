...
- Send an email or Slack alert instead of only writing to a log file
- Add CPU usage and network checks
- Rotate the log file so it doesn't grow indefinitely
- Package this as a small monitoring tool with Prometheus and Grafana

> The instance was terminated after this project to avoid charges.
